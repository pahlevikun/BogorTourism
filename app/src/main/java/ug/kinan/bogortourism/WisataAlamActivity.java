...
public class WisataAlamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.wisata_alam);

        recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        databaseHandler = new DatabaseHandler(WisataAlamActivity.this);
        dataList = databaseHandler.getAllWisata();
        Log.d("HASIL",""+dataList.size()+" "+dataList.get(1).getJudul());
        recyclerView.setHasFixedSize(true);
        linearLayoutManager = new GridLayoutManager(WisataAlamActivity.this,1);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter = new WisataAdapter(WisataAlamActivity.this,dataList);
